...
export function InvoiceGenerator() {
    ...
    const [items, setItems] = React.useState<LineItem[]>([
        { id: '1', description: "Web Design Services", details: "Initial consultation and design", quantity: 1, rate: 5000 },
        { id: '2', description: "Development", details: "Frontend implementation", quantity: 1, rate: 8000 },
    ])
    ...
    const handleDownloadPDF = async () => {
        ...
        if (blob) {
            saveAs(blob, `Invoice-${invoiceNumber || 'Draft'}.pdf`)
        }
    ...
    const handleShare = async () => {
        try {
            ...
            const file = new File([blob], `Invoice-${invoiceNumber || 'Draft'}.pdf`, { type: 'application/pdf' })

            if (navigator.share && navigator.canShare && navigator.canShare({ files: [file] })) {
                await navigator.share({
                    files: [file],
                    title: 'Invoice',
                    text: `Here is the invoice ${invoiceNumber} for ${clientCompany || 'your project'}.`,
                })
            } else {
            ...
            const blob = await generatePDFBlob()
            if (blob) saveAs(blob, `Invoice-${invoiceNumber || 'Draft'}.pdf`)
        }
    }
    ...
    return (
        <div className="w-full max-w-7xl mx-auto">
            ...
            <div className="flex flex-wrap justify-between items-center gap-4 mb-8 print:hidden">
                <h1 className="text-3xl md:text-4xl font-black text-white tracking-tight">Invoice Generator</h1>
                    ...
                    <div className="bg-byn-gray p-6 rounded-xl border border-white/10">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="space-y-2">
                                <label className="text-white font-medium">Invoice Number</label>
                                <Input
                                    value={invoiceNumber}
                            ...
                            <div className="p-8 print:p-4 flex-grow flex flex-col">
                                ...
                                <div className="flex justify-between items-start pb-4 border-b border-gray-200 print:pb-2">
                                    ...
                                    <div className="text-right">
                                        <h2 className="text-2xl font-black text-gray-900 tracking-widest">INVOICE</h2>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-3 gap-4 py-4 print:py-2">
                                    <div className="col-span-2">
                                        <p className="text-gray-500 text-xs uppercase tracking-wider font-bold mb-1">Bill To</p>
                                    ...
                                    <div className="text-left text-xs">
                                        ...
                                        <div className="grid grid-cols-2 gap-y-0.5 gap-x-2">
                                            ...
                                            <span className="font-bold text-gray-900 whitespace-nowrap">{invoiceNumber}</span>
                                            ...
                                            <span className="font-bold text-gray-900 whitespace-nowrap">{formatDate(dueDate)}</span>
                                        </div>
                                    </div>
                                </div>
